...
export default component$(() => {
	...
	//TODO: Add a loading spinner while fetching the active customer
	//TODO: Add a loading spinner while logging out
	//TODO: Make a header variant for the pages other than the home page
